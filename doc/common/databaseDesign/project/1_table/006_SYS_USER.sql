...
create table sys_user (
    ...
    default_start_url               varchar2(100),                                              -- Default startup page URL for each user
    ...
    security_question_1             varchar2(100),                                              -- From PERCI(For What? - sys_common_code.PORTAL_SECURITY_QUESTIONS)
    security_question_answer_1      varchar2(500),                                              -- From PERCI()
    security_question_2             varchar2(100),                                              -- From PERCI(For What? - sys_common_code.PORTAL_SECURITY_QUESTIONS)
    security_question_answer_2      varchar2(500),                                              -- From PERCI()
    portal_skin                     varchar2(100),                                              -- From PERCI(sys_common_code.PORTAL_SKIN)
    portal_security_role            varchar2(100),                                              -- From PERCI(sys_common_code.PORTAL_SECURITY_GROUP)
